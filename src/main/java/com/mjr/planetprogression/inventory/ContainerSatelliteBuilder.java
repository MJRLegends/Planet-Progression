...
public class ContainerSatelliteBuilder extends Container {
	private final TileEntitySatelliteBuilder tileEntity;

	public ContainerSatelliteBuilder(InventoryPlayer par1InventoryPlayer, TileEntitySatelliteBuilder tileEntity, EntityPlayer player) {
		...
		// Output Slot
		this.addSlotToContainer(new Slot(tileEntity, 4, 140, 35));
		int var3;
