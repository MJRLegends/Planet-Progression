...
public class Config {
	...
	public static void load() {
		...
		config.load();
		researchMode = config.get(Constants.CONFIG_CATEGORY_GENERAL_SETTINGS, "Research Mode", 0, "Research Modes: 0 - Basic Research Paper Method | 2 - Basic Satellite Research Method").getInt(0);
