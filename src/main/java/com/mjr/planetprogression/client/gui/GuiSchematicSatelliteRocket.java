...
public class GuiSchematicSatelliteRocket extends GuiPositionedContainer implements ISchematicResultPage {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRenderer.drawString(TranslateUtilities.translate("item.item_satellite_rocket.rocket.name"), 7, -20 + 27, 4210752);
		this.fontRenderer.drawString(TranslateUtilities.translate("container.inventory"), 88, 220 - 88 + 2 + 27, 4210752);
	}
