...
public class MainHandlerClient {
	...
	public void onGuiOpenEvent(GuiOpenEvent event) {
		if (((event.getGui() instanceof GuiCelestialSelection))) {
			...
			if(!Loader.isClassAvailable("com.mjr.extraplanets.compatibility.PlanetProgressionCompatibility") || !event.getGui().getClass().getName().equalsIgnoreCase("com.mjr.extraplanets.client.gui.screen.CustomCelestialSelection") || !event.getGui().getClass().getName().equalsIgnoreCase("asmodeuscore.core.astronomy.gui.screen.NewGuiCelestialSelection")) {
