package com.mjr.planetprogression.client.sounds;
 ...
 * @author micdoodle8
 */
public class SoundUpdaterSatelliteRocket extends MovingSound {
	private final EntityPlayerSP thePlayer;
	private final EntitySatelliteAutoRocket theRocket;
	private boolean soundStopped;
	private boolean ignition = false;

	public SoundUpdaterSatelliteRocket(EntityPlayerSP par1EntityPlayerSP, EntitySatelliteAutoRocket par2Entity) {
