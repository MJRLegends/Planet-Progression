...
public class CapabilityProviderStats implements ICapabilitySerializable<NBTTagCompound> {
	...
	public CapabilityProviderStats(EntityPlayerMP owner) {
		this.owner = owner;
		this.statsCapability = CapabilityStatsHandler.PP_STATS_CAPABILITY.getDefaultInstance();
	...
	public <T> T getCapability(Capability<T> capability, EnumFacing facing) {
		if (CapabilityStatsHandler.PP_STATS_CAPABILITY != null && capability == CapabilityStatsHandler.PP_STATS_CAPABILITY) {
			return CapabilityStatsHandler.PP_STATS_CAPABILITY.cast(statsCapability);
		}
