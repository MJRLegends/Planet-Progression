...
public class PlanetProgressionChannelHandler extends FMLIndexedMessageToMessageCodec<IPacket> {
	...
	public static PlanetProgressionChannelHandler init() {
		PlanetProgressionChannelHandler channelHandler = new PlanetProgressionChannelHandler();
		channelHandler.channels = NetworkRegistry.INSTANCE.newChannel(Constants.modID, channelHandler, new PlanetProgressionPacketHandler());
