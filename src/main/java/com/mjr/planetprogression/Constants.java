...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:galacticraftcore@[4.0.1.138,); required-after:galacticraftplanets@[4.0.1.138,); required-after:mjrlegendslib@[1.11.2-1.0.5,); after:extraplanets; after:moreplanets;"; // Keep the
																																																											// space at
	// the end!
