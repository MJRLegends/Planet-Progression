...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.8.9-1.0.8,); required-after:GalacticraftCore@[4.0.1.174,); required-after:GalacticraftPlanets@[4.0.1.174,); after:extraplanets; after:moreplanets;";
