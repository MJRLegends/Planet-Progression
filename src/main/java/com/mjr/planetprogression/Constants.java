...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.12.2-1.1.6,); required-after:galacticraftcore@[4.0.2.255,); required-after:galacticraftplanets@[4.0.2.255,); after:extraplanets; after:moreplanets; after:blankplanet; after:zollerngalaxy; before:asmodeuscore@[0.0.19,);";
