...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.8.9-1.1.1,); required-after:GalacticraftCore@[4.0.1.185,); required-after:GalacticraftPlanets@[4.0.1.185,); after:extraplanets; after:moreplanets;";
