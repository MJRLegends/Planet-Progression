	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		if (args.length == 1) {
			...
			try {
				...
				playerBase.addChatMessage(new TextComponentString(EnumColor.AQUA + "You have removed all Planets & Moons! from the discovered list for: " + playerToAddFor.getName()));
