...
public class BlockSatelliteBuilder extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	...
	public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		...
		if (te instanceof TileEntitySatelliteBuilder) {
			final TileEntitySatelliteBuilder crystallizer = (TileEntitySatelliteBuilder) te;
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntitySatelliteBuilder();
	}

	@Override
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		final TileEntitySatelliteBuilder var7 = (TileEntitySatelliteBuilder) worldIn.getTileEntity(pos);
